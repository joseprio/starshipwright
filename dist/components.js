import { COMPONENT_GRID_SIZE, COMPONENT_MAXIMUM_SIZE, CANVAS_SHIP_EDGE, } from "./constants";
...
export const components = [
    // Bordered block
    function (cfx, shipRandomizer, factionRandomizer, w, h, hw, hh, size, v, componentChances, colorData, nextpass, totaldone, totalcomponents) {
    ...
    function (cfx, shipRandomizer, factionRandomizer, w, h, hw, hh, size, v, componentChances, colorData, nextpass, totaldone, totalcomponents, getCellPhase) {
